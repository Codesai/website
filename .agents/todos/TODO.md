...
| CWS-LH-001 | DOING | P0 | Rendimiento | Convertir `top_picture.png` a AVIF/WebP, añadir fallback, `srcset`, dimensiones y `fetchpriority="high"`. | La imagen conserva calidad; ahorro ≥ 100 KB; no usa lazy loading; LCP móvil mediano ≤ 2,5 s en 3 pasadas. |
